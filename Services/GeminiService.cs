...
🔥 ОБЯЗАТЕЛЬНО укажи basalMetabolicRate (число в ккал) и metabolicRateCategory (""Низкий"", ""Нормальный"" или ""Высокий"")";
            ...
            if (userInfo.Any())
            {
                ...
                prompt += "\n\nИспользуй эту информацию для более точного расчета BMR по формулам выше.";
            }
...
Если не удалось распознать тренировку:
{
  ...
  ""errorMessage"": ""Не удалось распознать информацию о тренировке""
        ...
        {
            // Получаем текущую локаль из настроек приложения
            // Можно заменить на нужную логику получения локали
            return System.Globalization.CultureInfo.CurrentCulture.Name;
            // Или явно задать: return "ru-RU"; для русского
        }
